...
pattern = r"\{/\* Total bill and Actions wrapper - Clean Alignment \*/\}.*?className=\"bg-slate-50 border border-slate-200 text-slate-800 rounded px-1\.5 py-1 text-\[10px\] cursor-pointer font-bold focus:outline-none\""
