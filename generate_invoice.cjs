...
const invoiceComponent = `import { useEffect, useState } from 'react';
...
export default function PrintInvoice() {
  ...
  return (
    <div className="bg-white min-h-screen py-8 font-serif print:py-0 print:bg-white flex justify-center text-black">
      <div className="w-[210mm] min-h-[297mm] bg-white print:shadow-none p-10 relative box-border text-[13px] leading-tight flex flex-col">
          ...
          <div className="flex justify-center items-center gap-3 mb-2">
            <div className="w-16 h-16 rounded-full border-2 border-black flex items-center justify-center overflow-hidden">
                <div className="w-full h-full bg-slate-800 flex items-center justify-center text-white">
                    {/* Mock logo */}
                    <span className="font-bold italic text-xl">MK</span>
                </div>
            </div>
        ...
        {/* Main Items Table */}
        <table className="w-full border-collapse border border-black text-center text-xs font-bold flex-1">
          <thead>
        ...
        <div className="mt-4 font-bold border border-black inline-block px-3 py-1 bg-gray-100 text-sm">
          Pyment Status: cash on delivery
        </div>

        {/* Signatures */}
        <div className="mt-auto pt-16 flex justify-between items-end font-bold text-sm">
...
fs.writeFileSync('src/pages/PrintInvoice.tsx', invoiceComponent);
console.log("Invoice template replaced");
